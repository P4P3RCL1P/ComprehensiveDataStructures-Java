...
public class HashTableArrayList extends AbstractHashTable{
	...
	HashTableArrayList()
	{
		hashTable = new ArrayList<HashTableNode>(INIT_TABLE_SIZE);
		numElements = 0;
	 ...
	 */
	HashTableArrayList(final int CUSTOM_TABLE_SIZE)
	{
		hashTable = new ArrayList<HashTableNode>(CUSTOM_TABLE_SIZE);
		numElements = 0;
	...
	public void resizeHashTable()
	{
		...
		ArrayList<HashTableNode> largerHashTable = new ArrayList<HashTableNode>(hashTableSize);
		for(int i=0; i<hashTableSize; i++)
		{
	...
	{
		HashTableArrayList table = new HashTableArrayList();
