...
/*
 * JUnit class for testing doubly linked list methods
 */
/**
 * <p>Title: DoubleLinkedListTest</p>
 *
 * <p>Description: </p>
...
public class DoubleLinkedListTest {
	 ...
	 */
	private DoubleLinkedList testEmptyList = new DoubleLinkedList();
	/**
	 * Intialized list with a few nodes to ensure proper functionality of a simple linked list
	 */
	private DoubleLinkedList testInitializedList = new DoubleLinkedList();
	...
	void testGetAtIndex() {
		...
		assertThrows(IndexOutOfBoundsException.class, () -> testEmptyList.getAtIndex(-1));
	}
	...
	void testSetAtIndex() {
		...
		assertThrows(IndexOutOfBoundsException.class, () -> testEmptyList.setAtIndex(-1,3));
	}
	...
	void testAddAtIndex() {
		...
		assertThrows(IndexOutOfBoundsException.class, () -> testEmptyList.addAtIndex(-1,5));
	}
	...
	{
		assertEquals(testInitializedList.getAtIndex(3).toString(), "600");
		assertEquals(testInitializedList.removeData(600).toString(), "<Node: 600>");
		assertEquals(testInitializedList.getAtIndex(3).toString(), "8");
		assertEquals(testInitializedList.getAtIndex(4).toString(), "1111");
	}
