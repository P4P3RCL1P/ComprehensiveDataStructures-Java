...
public class MaxHeapTreeLinkedList extends AbstractHeapTree {
	...
	{
		MaxHeapTreeLinkedList example = new MaxHeapTreeLinkedList();
		System.out.println(example.isEmpty());
		System.out.println(example.height());
		System.out.println(example.nodeCount());
		example.add(100);
		HeapTreeNode output = example.search(example.getRoot(), 100);
