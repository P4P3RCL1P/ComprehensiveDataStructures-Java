...
/*
 * Implementation of int max heap tree.
...
public class MaxHeapTree extends AbstractHeapTree {
	...
	{
		MaxHeapTree exampleHeapTree = new MaxHeapTree();
		System.out.println(exampleHeapTree.isEmpty());
		//exampleHeapTree.insert(100);
		//exampleHeapTree.remove(20);
		exampleHeapTree.insert(100);
		exampleHeapTree.insert(80);
		exampleHeapTree.insert(120);
		exampleHeapTree.insert(90);
		exampleHeapTree.insert(75);
		exampleHeapTree.insert(110);
		exampleHeapTree.insert(130);
